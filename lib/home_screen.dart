...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int woied = 44418;
  String errorMessage = "";
  // untuk menampung gambar iconnya
  String abbreviation = "";
  // membuat variable list untuk menampung data list min dan max temp dan juga iconnya selama 7 hari
  var minTemperatureForecast = List.filled(7, 0);
  var maxTemperatureForecast = List.filled(7, 0);
  var abrrevationForecast = List.filled(7, ' ');

  // masukan link api url untuk search
  String searchApiUrl = "https://www.metaweather.com/api/location/search/?query=";
  // masukan link api url untuk location
  ...
  Future<void> getLocation()async{
    ...
    var conselidatedWeather = result["consolidated_weather"];
    var data = conselidatedWeather[0];
  ...
  Future<void> getSearch(String input) async{
    try{
      ...
      setState(() {
        errorMessage = 'Maaf kota yang anda cari tidak ada awokawokao';
      });
    }
  ...
  Future<void> getSevenDays() async{
    ...
    for(var i = 0; i < 7 ; i++){
      ...
      setState(() {
        ...
        abrrevationForecast[i] = data['weather_state_abbr'];
      });
    }
  }

  // membuat function untuk menerima inputan di search bar
    ...
    return Container(
      ...
      : Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              // untuk menampilkan icon, temp, location
              Column(
                children: [
                  Center(
                    child:Image.network
  ...
  Widget forecastElement(daysFromNow, abbrevation, maxTemp, minTemo){
